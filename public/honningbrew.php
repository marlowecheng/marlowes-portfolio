                ...
                <div class="grid-col">
                    ...
                    <div class="lb-container column">
                        <div class="grid-col">
                            ...
                            <a class="column span5" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-logo.jpg'); ?>" data-lightbox="honningbrew-logos" data-title="Honningbrew Meadery Logo" data-alt="Honningbrew Meadery Logo">
                                <img src="<?php echo get_public_url('images/proj-honningbrew/honningbrew-logo.jpg'); ?>" alt="Honningbrew Meadery Logo">
                            </a>
                            <a class="column span5" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-logo-dark.jpg'); ?>" data-lightbox="honningbrew-logos" data-title="Honningbrew Meadery Logo Version for Dark Backgrounds" data-alt="Honningbrew Meadery Logo Version for Dark Backgrounds">
       ...
       <section class="proj-process">
            <div class="container">
                <div class="grid-col">
                    ...
                    <div class="lb-container column">
                        <div class="grid-col">
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-card-rough.jpg'); ?>" data-lightbox="honningbrew-roughs" data-title="Rough for business cards" data-alt="rough draft for honningbrew meadery's business card">
                            ...
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-envelope-rough.jpg'); ?>" data-lightbox="honningbrew-roughs" data-title="Roughs for envelopes" data-alt="rough draft for honningbrew meadery's business card">
                            ...
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-letterhead-rough.jpg'); ?>" data-lightbox="honningbrew-roughs" data-title="Roughs for letterhead" data-alt="rough draft for honningbrew meadery's business card">
       ...
       <section class="proj-process">
            <div class="container">
                <div class="grid-col">
                    ...
                    <div class="lb-container column">
                        <div class="grid-col">
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-card1.jpg'); ?>" data-lightbox="honningbrew-deliverables" data-title="Honningbrew Meadery Business Card" data-alt="Honningbrew Meadery's Business Card">
                                <img src="<?php echo get_public_url('images/proj-honningbrew/honningbrew-card1.jpg'); ?>" alt="Honningbrew Meadery's Business Card">
                            </a>
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-card2.jpg'); ?>" data-lightbox="honningbrew-deliverables" data-title="Honningbrew Meadery Business Card" data-alt="Honningbrew Meadery's Business Card">
                                <img src="<?php echo get_public_url('images/proj-honningbrew/honningbrew-card2.jpg'); ?>" alt="Honningbrew Meadery's Business Card">
                            </a>
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-envelope1.jpg'); ?>" data-lightbox="honningbrew-deliverables" data-title="Honningbrew Meadery Envelope" data-alt="Honningbrew Meadery's Envelope">
                                <img src="<?php echo get_public_url('images/proj-honningbrew/honningbrew-envelope1.jpg'); ?>" alt="Honningbrew Meadery's Envelope">
                            </a>
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-envelope2.jpg'); ?>" data-lightbox="honningbrew-deliverables" data-title="Honningbrew Meadery Envelope" data-alt="Honningbrew Meadery's Envelope">
                                <img src="<?php echo get_public_url('images/proj-honningbrew/honningbrew-envelope2.jpg'); ?>" alt="Honningbrew Meadery's Envelope">
                            </a>
                            <a class="column span4" href="<?php echo get_public_url('images/proj-honningbrew/honningbrew-letterhead.jpg'); ?>" data-lightbox="honningbrew-deliverables" data-title="Honningbrew Meadery Letterhead" data-alt="Honningbrew Meadery's Letterhead">

...
<body>
    ...
    <main>
        <section class="about-me">
            <div class="container">
                <div class="grid-col">
                    ...
                    <img src="<?php echo get_public_url('images/about/marlowe-about.jpg'); ?>" alt="" class="column span4">
                </div>
            </div>
        </section>
        <section class="skills">
            <div class="container">
                <div class="grid-col">
                    <div class="skill-card column span4">
                        <h3>Languages</h3>
                        <ul class="bulleted">
                            <li>HTML</li>
                            <li>CSS</li>
            ...
            <div class="container">
                <div class="grid-col">
                    ...
                    <div class="card column grid-col">
                        <img src="<?php echo get_public_url('images/about/community.svg'); ?>" alt="4 frogs together" class="column span2">
                    ...
                    <div class="card column grid-col">
                        <img src="<?php echo get_public_url('images/about/curiosity.svg'); ?>" alt="a frog with a question mark on top of its head" class="column span2">
                        <div class="column span10">
                            <h3>Curiosity</h3>
                    ...
                    <div class="card column grid-col">
                        <img src="<?php echo get_public_url('images/about/humor.svg'); ?>" alt="a frog with a happy face" class="column span2">
                        <div class="column span10">
                            <h3>Humor</h3>
                    ...
                    <div class="card column grid-col">
                        <img src="<?php echo get_public_url('images/about/accountability.svg'); ?>" alt="a frog with an exclamation mark above its head" class="column span2">
                        <div class="column span10">
        ...
        <section class="goals">
            <div class="container">
                <div class="grid-col">
                    ...
                    <img src="<?php echo get_public_url('images/about/short.svg'); ?>" alt="frog horizontally condensed" class="column span2">
                    <div class="column span10">
                        <h3>Short Term</h3>
                        <ul class="bulleted">
                    ...
                    <img src="<?php echo get_public_url('images/about/long.svg'); ?>" alt="frog horizontally expanded" class="column span2">
                    <div class="column span10">
                        <h3>Long Term</h3>
                        <ul class="bulleted">

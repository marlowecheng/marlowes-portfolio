                ...
                <div class="grid-col">
                    ...
                    <div class="column grid-col">
                        <div class="column proj-card grid-col">
                            <a href="<?php echo get_public_url('chahouse.php'); ?>" class="column span4 span8-md span12-lg"><img src="images/proj-chahouse/chahouse-mockup-poster1.jpg" alt=""></a>
                        ...
                        <div class="column proj-card grid-col">
                            <a href="<?php echo get_public_url('honningbrew.php'); ?>" class="column span4 span8-md span12-lg"><img src="images/proj-honningbrew/honningbrew-meadery-stationery-mockup.jpg" alt=""></a>
                            <div class="card-content column span4 span8-md span12-lg">
                        ...
                        <div class="column proj-card grid-col">
                            <a href="<?php echo get_public_url('bao-gsap.php'); ?>" class="column span4 span8-md span12-lg"><img src="images/proj-gsap/bao-mockup.jpg" alt=""></a>
                            <div class="card-content column span4 span8-md span12-lg">
                        ...
                        <div class="column proj-card grid-col">
                            <a href="<?php echo get_public_url('restwel.php'); ?>" class="column span4 span8-md span12-lg"><img src="images/proj-restwel/restwel-mockup.jpg" alt=""></a>
                            <div class="card-content column span4 span8-md span12-lg">
